...
public class GuiIngame extends Gui
{
    ...
    public void func_96136_a(ScoreObjective par1ScoreObjective, int par2, int par3, FontRenderer par4FontRenderer)
    {
    ...
    public void func_110327_a(int par1, int par2)
    {
    ...
    public void func_130015_b(float par1, int par2, int par3)
    {
        if (par1 < 1.0F)
        {
            par1 *= par1;
