...
import com.cthulhu.client.hooks.hook.HookMinecraft;
import com.cthulhu.client.hooks.overrides.OverrideGuiIngame;
...
public class Minecraft implements IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException
    {
        ...
        //SPOUT START
        this.ingameGUI = new OverrideGuiIngame(this);
        //SPOUT END
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                	...
                	//SPOUT START
                	HookMinecraft.onKeyPress(Keyboard.getEventKey());
                	//SPOUT END
